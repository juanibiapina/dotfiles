# Vendored from https://github.com/romkatv/zsh-defer (MIT License).
# Defers execution of a command until the zsh line editor is idle.
# Update: curl -fsSL https://raw.githubusercontent.com/romkatv/zsh-defer/master/zsh-defer.plugin.zsh
#
