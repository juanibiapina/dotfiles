...
beautiful.init("/home/juan/workspace/juanibiapina/dotfiles/dotfiles/awesome/.config/awesome/theme.lua")
...
-- Hide border when clients are maximized
...
awful.rules.rules = {
    ...
    { rule = { class = "org.gnome.Nautilus" },
      properties = { screen = screen.primary, tag = "9" } },
}
-- }}}
