...
map('<Leader>ba', ':bufdo :Bwipeout', 'Buffer: Close all buffers')
...
map('<Leader>bl', ':b#', 'Buffer: Switch to last used buffer')
map('<Leader>bo', ':BufferLineCloseOthers', 'Buffer: Close all other buffers')
map('<Leader>bn', ':BufferLineCycleNext', 'Buffer: Next buffer')
map('<Leader>bp', ':BufferLineCyclePrev', 'Buffer: Previous buffer')
