---
description: Build a distinctive frontend with design-first thinking
---

# Frontend

Build a frontend component, page, or application with intentional design that avoids generic AI aesthetics.
...
Use the `browse` skill to inspect the result visually:

- Screenshot the implementation
- Compare against the stated design direction
- Check typography, color, spacing, and motion choices
- Look for generic or default-looking elements that slipped through
