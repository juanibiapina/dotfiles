...

{
  ...
  # syncthing secrets
  age.secrets.macr-syncthing-cert = {
    file = ../../secrets/macr-syncthing-cert.age;
  };

  age.secrets.macr-syncthing-key = {
    file = ../../secrets/macr-syncthing-key.age;
  };
  ...
  home.file = {
    "workspace/contentful/.envrc".text = ''
      export CODING_AGENT="pi-bedrock-sonnet"
